...
def to_json(host, findings: list[Finding]) -> str:
    return json.dumps({
        ...
        "host": {
            ...
            "is_root": host.is_root, "tags": sorted(host.tags),
        },
...
def main(argv: list[str] | None = None) -> int:
    ...
    # After a scan on an interactive terminal, offer to actually harden.
